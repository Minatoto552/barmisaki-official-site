...
import { ArrowDown, ArrowRight, ArrowUpRight, CalendarDays, Clock3, DoorOpen, Users } from 'lucide-react';
...
import { FeaturedCasts } from './cast/featured-casts';
...
export function HomeClient({ casts: initialCasts }: { casts: Cast[]; news: NewsItem[] }) {
  ...
  return <main className="home-luxury overflow-hidden bg-[#07060d] text-white">
    ...
    <div className="home-feature"><FeaturedCasts casts={pickups} onProfile={setProfileCast} suspended={profileCast !== null} home />{!pickups.length && <p className="home-pickup-empty">NEXT SELECTION COMING SOON</p>}</div>
