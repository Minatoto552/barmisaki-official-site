  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/[.07] bg-[#080710]/72 backdrop-blur-xl">
      <div className="mx-auto flex h-[76px] max-w-[1440px] items-center justify-between px-5 sm:px-8 xl:px-[72px]">
        <Link href="/" aria-label="BarMisaki ホーム" className="shrink-0">
          <img src="/barmisaki-logo.png" alt="BarMisaki" className="h-11 w-auto object-contain sm:h-12" />
        </Link>
      ...
      {open && <div className="fixed inset-0 z-[90] flex min-h-dvh flex-col bg-[#06050b] p-5 xl:hidden">
        <div className="flex items-center justify-between"><img src="/barmisaki-logo.png" alt="BarMisaki" className="h-12 w-auto" /><button onClick={() => setOpen(false)} className="grid size-11 place-items-center rounded-xl border border-white/15" aria-label="メニューを閉じる"><X /></button></div>
