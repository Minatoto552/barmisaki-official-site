  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/[.07] bg-[#080710]/72 backdrop-blur-xl">
      <div className="mx-auto flex h-[76px] max-w-[1440px] items-center justify-between px-5 sm:px-8 xl:px-[72px]">
        {pathname === '/' ? <span aria-hidden="true" className="block h-11 w-[72px] shrink-0 sm:h-12" /> : <a href="/" aria-label="BarMisaki ホーム" className="shrink-0"><img src="/barmisaki-logo.png" alt="BarMisaki" width="72" height="48" className="h-11 w-auto object-contain sm:h-12" /></a>}
